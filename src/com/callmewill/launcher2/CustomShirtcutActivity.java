...
public class CustomShirtcutActivity extends Activity implements OnClickListener {
	...
	private TextView tvPickActivity;
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		outState.putCharSequence("btPickActivity_text", tvPickActivity.getText());
	}
	...
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
		if (savedInstanceState != null && savedInstanceState.size() >= 7) {
			...
			tvPickActivity.setText(savedInstanceState.getCharSequence("btPickActivity_text"));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iconCache=new IconCache((LauncherApplication) getApplication());
		setContentView(R.layout.custom_shirtcuts);
		tvPickActivity=(TextView) findViewById(R.id.pick_activity);
//		btPickActivity.setOnClickListener(this);
	...
	private ShortcutInfo getAppInfo() {
		...
		if (intent != null && intent.getAction() != null &&
			...
			return new LauncherProvider().getItemInfoById(id,this);
		}
		return null;
	}

	@SuppressWarnings("deprecation")
	private void loadFromAppInfo(ShortcutInfo info) {
		if (info == null)
			return;
		edLabel.setText(info.title);
		mIntent = info.intent;
		btPickIcon.setImageDrawable(new BitmapDrawable(info.getIcon(iconCache)));
		...
		if (component != null) {
			...
			tvPickActivity.setText(info.title);
	}
